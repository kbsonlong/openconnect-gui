...
if(APPLE)
    get_target_property(_qcocoa_dylib_loc Qt6::QCocoaIntegrationPlugin LOCATION)
    get_filename_component(_qcocoa_dylib "${_qcocoa_dylib_loc}" REALPATH)
    if(Qt6Core_VERSION VERSION_GREATER_EQUAL "6.0")
        get_target_property(_qmacstyle_dylib_loc Qt6::QMacStylePlugin LOCATION)
        get_filename_component(_qmacstyle_dylib "${_qmacstyle_dylib_loc}" REALPATH)
    endif()
endif()
